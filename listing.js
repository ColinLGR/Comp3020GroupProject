...
let imagePreviews = document.getElementById("previews");
let image = document.createElement("img");
image.className = "image-preview";
image.src = data.img;
imagePreviews.appendChild(image);
document.getElementById("main-photo").setAttribute("src", data.img);
...
let simulateReply = (userMsg) => {
    ...
    if (userMsg.includes("available")) {
        ...
        replyText = "I'm not really sure what you mean, can we stick to talking about the textbook"
    }
    setTimeout(() => {
        const bubble = document.createElement("div");
        bubble.classList.add("chat-bubble");
